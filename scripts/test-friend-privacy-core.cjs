...
assert.equal(clientPrivacy.formatPublicUserName("Joann Pollard"), "Joann P.");
assert.equal(clientPrivacy.formatPublicUserName("Mary Anne Van Buren"), "Mary V.");
...
assert.equal(clientPrivacy.formatSuggestedConnectionName("Joann Pollard"), "Joann P.");
assert.equal(clientPrivacy.formatSuggestedConnectionName("  Joann   Pollard  "), "Joann P.");
assert.equal(clientPrivacy.formatSuggestedConnectionName("Madonna"), "Madonna");
assert.equal(clientPrivacy.formatSuggestedConnectionName("Anne-Marie O'Neill"), "Anne-Marie O.");
assert.equal(clientPrivacy.formatSuggestedConnectionName("María de la Cruz"), "María C.");
assert.equal(clientPrivacy.formatSuggestedConnectionName("joann@example.com"), "Sideline Parent");
assert.equal(clientPrivacy.formatSuggestedConnectionName("", "Padre o madre de Sideline"), "Padre o madre de Sideline");
assert.equal(clientPrivacy.formatFriendRequestSenderName("Joann Pollard"), "Joann P.");
...
assert.equal(serverPrivacy.formatSuggestedConnectionName("Joann Pollard"), "Joann P.");
