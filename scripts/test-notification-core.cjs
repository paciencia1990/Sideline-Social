...
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", conversationId: "private-1", messageId: "message-1", conversationType: "parent" }), "/teams/team-1/messages/private-1?messageId=message-1");
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", conversationId: "private-1" }), "/teams/team-1/messages/private-1");
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", activeMode: "coach" }), null);
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", activeMode: "parent" }), null);
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", conversationId: "bad/path", conversationType: "parent" }), null);
...
assert.equal(core.getNotificationDestination({ type: "teamPrivateMessage", teamId: "team-1", conversationId: "private-1", activeMode: "coach" }).includes("profile"), false);
