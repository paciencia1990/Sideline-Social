...
assert.match(recorder, /ensureVoiceRecordingPermission\(Audio\)/);
assert.ok(recorder.indexOf("ensureVoiceRecordingPermission(Audio)") > recorder.indexOf("const startRecording"));
