...
for (const required of ["Audio.requestPermissionsAsync", "MAX_DURATION_MS = 90_000", "MAX_SIZE_BYTES = 2 * 1024 * 1024", "AppState.addEventListener", "previewed: false", "deleteAsync"]) assert.equal(recorder.includes(required), true, required);
