...
export default function FriendChatManageScreen() {
  ...
  const confirmMemberAction = (member: FriendConversationMember) => {
    ...
    options.push({ text: t("chat.reportUser"), onPress: () => router.push({ pathname: "/settings/safety", params: { conversationId, reportedUserId: member.userId } }) });
