...
Status: **PRELIMINARY — REQUIRES OWNER REVIEW.** Do not submit this worksheet. It reflects the current production-capable Android source and integrated SDKs. The normal production binary hides Coach AI; any staging or production-connected internal-testing App Bundle that enables Coach AI must include the conditional AI rows below.
