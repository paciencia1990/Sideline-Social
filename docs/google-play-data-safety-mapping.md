...
Status: **PRELIMINARY — REQUIRES OWNER REVIEW.** Do not submit this worksheet. It reflects the current production-capable Android source and integrated SDKs, not merely declared permissions. Coach AI is excluded because it is disabled and isolated.
...
| App activity — Other user-generated content | Yes | No* | No | Optional | App functionality, safety/security | Team/Squad metadata, reports, child-team links, free-form UGC | Deleted/anonymized/retained report evidence | Declare collected |
