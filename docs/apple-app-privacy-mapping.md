...
Status: **PRELIMINARY — REQUIRES OWNER/PRIVACY-COUNSEL REVIEW AND FINAL IPA VERIFICATION.** Do not submit these answers from this document alone. Current practices only; Coach AI is excluded because it is disabled and isolated.
...
| User Content — Other User Content | Yes, optional | App Functionality | Yes | No | Team/Squad/child data, reports, free-form content and RSVP-style replies | Select collected, linked, not tracking |
